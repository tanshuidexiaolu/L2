...
def getData():
    ...
    for imgUrl in fileList:
        ...
        print('转化后脸型：', shape)
        # 存储数据
        tempDict = {'url': imgUrl, 'age': age, 'gender': gender, 'shape': shape}  # 以key-value的形式存储
        # 追加在列表里，为之后显示嫌疑人界面使用
...
def showResult():
    ...
    while True:
        ...
        if len(totalList) == 1:
            ...
            drawResult(0, (160, 112), (375, 155), (375, 190), (397, 225))
            drawResult(1, (160, 267), (375, 310), (375, 345), (397, 379))
        elif len(totalList) == 3:
            drawResult(0, (160, 112), (375, 155), (375, 190), (397, 225))
            drawResult(1, (160, 267), (375, 310), (375, 345), (397, 379))
            drawResult(2, (160, 422), (375, 465), (375, 500), (397, 535))
        elif len(totalList) == 4:
            drawResult(0, (160, 112), (375, 155), (375, 190), (397, 225))
            drawResult(1, (160, 267), (375, 310), (375, 345), (397, 379))
            drawResult(2, (160, 422), (375, 465), (375, 500), (397, 535))
            drawResult(3, (580, 158), (795, 195), (795, 230), (817, 265))
        elif len(totalList) == 5:
            drawResult(0, (160, 112), (375, 155), (375, 190), (397, 225))
            drawResult(1, (160, 267), (375, 310), (375, 345), (397, 379))
            drawResult(2, (160, 422), (375, 465), (375, 500), (397, 535))
            drawResult(3, (580, 155), (795, 195), (795, 230), (817, 265))
            drawResult(4, (580, 307), (795, 351), (795, 386), (817, 421))
        elif len(totalList) == 6:
            drawResult(0, (160, 112), (375, 155), (375, 190), (397, 225))
            drawResult(1, (160, 267), (375, 310), (375, 345), (397, 379))
            drawResult(2, (160, 422), (375, 465), (375, 500), (397, 535))
            drawResult(3, (580, 155), (795, 195), (795, 230), (817, 265))
            drawResult(4, (580, 307), (795, 351), (795, 386), (817, 421))
            drawResult(5, (580, 465), (795, 505), (795, 542), (817, 577))
...
def drawResult(index, imagePos, agePos, genderPos, shapePos):
    ...
    renderText(age, agePos)
    renderText(gender, genderPos)
    renderText(shape, shapePos)
